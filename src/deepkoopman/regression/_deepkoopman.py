...
from deepkoopman.regression.inns.freia_allinone import FreiaINN
from deepkoopman.regression._extensionlayer import CNNExtensionLayer
from deepkoopman.regression._koopmanoperator import StableKoopmanOperator,  OrthogonalLinear

from .callbacks import KoopmanParameterMonitor, LossRecorder
from sklearn.utils.validation import check_is_fitted
from deepkoopman.regression._base import BaseRegressor
from deepkoopman.regression._preprocessing import SeqDataModule

from deepkoopman.regression.inns._inn_factory import INNFactory
from deepkoopman.regression._extension_factory import ExtensionFactory
from deepkoopman.regression.inns._hybrid_inn_wrapper import HybridINNWrapper
...
class DeepKoopman(BaseRegressor):
    """
    ...
    def fit(self, x: Union[np.ndarray, List[np.ndarray]], 
            ...
            debug_mode: bool = False) -> "DeepKoopman":
        """
        Train the model
...
import pickle
from deepkoopman.regression._preprocessing import (TensorNormalize, InverseTensorNormalize)
